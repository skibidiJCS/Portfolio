    ...
    <main>
      ...
      <section className="community community-connected" id="community" data-travel>
        ...
        <div className="community-stories">
          ...
          <article className="community-story" data-travel><div className="community-logo" data-travel><img src="/assets/muhc.png" alt="McGill University Health Centre" loading="lazy"/></div><div className="community-copy reveal"><span className="category">Healthcare</span><h3>McGill University<br/>Health Centre</h3><p>I volunteer at the MUHC, helping out in a hospital setting.</p></div></article>
          <article className="community-story" data-travel><div className="community-logo" data-travel><img src="/assets/lachine.png" alt="Demi-marathon Lachine" loading="lazy"/></div><div className="community-copy reveal"><span className="category">Community sport</span><h3>Demi-marathon<br/>Lachine</h3><p>I helped on site as a volunteer at the Demi-marathon Lachine.</p></div></article>
        </div>
      </section>
